...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section { return section == 0 ? 1 : (section == 1 ? self.store.profiles.count : 5); }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) { case 0: [self assignApp]; break; case 1: [self configureProxy]; break; case 2: [self configureLocation]; break; case 3: [self exportBackup]; break; default: [self showDiagnostics]; }
}
